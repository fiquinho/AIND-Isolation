...
RESULTS = "/output/results - {}-{}-{} - {}.{}hs.txt".format(DATE.day, DATE.month, DATE.year, DATE.hour, DATE.minute)
...
def play_matches(cpu_agents, test_agents, num_matches):
    ...
    return [100 * total_wins[x[1].player] / total_matches for x in enumerate(test_agents)]
